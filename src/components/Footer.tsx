      ...
      <div className="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center">
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg p-10 mx-auto max-w-3xl relative"
          >
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-400 to-blue-600"></div>
            
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to start trading smarter?</h2>
            <p className="text-gray-600 mb-8 max-w-lg mx-auto">
              Explore our time series analysis tools and take your trading to the next level
            </p>
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              <div className="w-8 h-8 rounded-md bg-gradient-to-tr from-blue-600 to-blue-400 flex items-center justify-center mr-2">
          ...
          <p className="text-center text-gray-500 text-sm mt-8">
            © {new Date().getFullYear()} AlgoTrade. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
